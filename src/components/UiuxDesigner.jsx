...
const name = useParams()
  ...
  useEffect(() => {
    async function data() {
      const res = await axios.get("http://localhost:8070/test/view/uiuxDesigner")  
      try {
          console.log('====================================');
  ...
  axios.post("http://localhost:8070/test/check" , {
      id:id,question:question,answer:answer ,categorynew:"uiuxDesigner"
  ...
  return (
    <div>
      {localStorage.setItem("categorynew" , "uiuxDesigner")}
