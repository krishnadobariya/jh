...
const categoryname = useParams()
  ...
  useEffect(() => {
    console.log("this is log" ,categoryname);
    async function data() {
      const res = await axios.get(`http://localhost:8070/test/view/webDesigner`)  
      try {
          console.log('====================================');
  ...
  axios.post("http://localhost:8070/test/check" , {
      id:id,question:question,answer:answer , categorynew:"webDesigner"
  ...
  return (
    <div>
      {localStorage.setItem("categorynew" , "webDesigner")}
