...
const name = useParams()
  ...
  useEffect(() => {
    async function data() {
      const res = await axios.get("http://localhost:8070/test/view/webDeveloper")  
      try {
          console.log('====================================');
  ...
  axios.post("http://localhost:8070/test/check" , {
      id:id,question:question,answer:answer , categorynew:"webDeveloper"
  ...
  return (
    <div>
      {localStorage.setItem("categorynew" , "webDeveloper")}
